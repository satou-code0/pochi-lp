...
const faqs = [
  {
    ...
    answer: '規模や複雑さによって異なりますが、小規模なアプリケーションで約2〜3ヶ月、中規模で3〜6ヶ月程度です。要件定義の段階で具体的な納期をご提案します。',
  },
  {
  ...
  },
  {
    ...
    answer: 'ISO27001認証取得済みで、お客様のデータは256bit暗号化で保護します。機密性の高い業界（金融・医療など）での導入実績も多数あり、安心してご利用いただけます。',
  },
  {
